...
module Form3PublicApi
  # DirectDebitReturnReversalAdmission Model.
  class DirectDebitReturnReversalAdmission < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      attributes = Attributes33.from_hash(hash['attributes']) if hash['attributes']
      ...
      relationships = Relationships12.from_hash(hash['relationships']) if hash['relationships']
      type = hash.key?('type') ? hash['type'] : SKIP
      version = hash.key?('version') ? hash['version'] : SKIP

      # Create object from extracted values.
      DirectDebitReturnReversalAdmission.new(attributes,
                                             id,
                                             organisation_id,
                                             created_on,
                                             modified_on,
