...
module Form3PublicApi
  # BeneficiaryDebtorAccountHoldingEntity Model.
  class BeneficiaryDebtorAccountHoldingEntity < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      BeneficiaryDebtorAccountHoldingEntity.new(bank_address,
                                                bank_id,
                                                bank_id_code,
                                                bank_ids,
                                                bank_name,
