...
module Form3PublicApi
  # QueryResponseAdmission Model.
  class QueryResponseAdmission < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      attributes = QueryResponseAdmissionAttributes.from_hash(hash['attributes']) if
        hash['attributes']
      ...
      relationships = QueryResponseAdmissionRelationships.from_hash(hash['relationships']) if
        hash['relationships']

      # Create object from extracted values.
      QueryResponseAdmission.new(attributes,
                                 id,
                                 organisation_id,
                                 version,
                                 created_on,
