...
module Form3PublicApi
  # DirectDebitDecisionAdmissionRelationships Model.
  class DirectDebitDecisionAdmissionRelationships < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      DirectDebitDecisionAdmissionRelationships.new(direct_debit,
                                                    direct_debit_decision)
    end
  end
end
