...
module Form3PublicApi
  # ReturnReversal Model.
  class ReturnReversal < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      relationships = Relationships23.from_hash(hash['relationships']) if hash['relationships']
      type = hash.key?('type') ? hash['type'] : SKIP
      version = hash.key?('version') ? hash['version'] : SKIP

      # Create object from extracted values.
      ReturnReversal.new(id,
                         organisation_id,
                         attributes,
                         created_on,
                         modified_on,
