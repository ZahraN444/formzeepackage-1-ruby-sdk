...
module Form3PublicApi
  # NewTransactionFile Model.
  class NewTransactionFile < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      attributes = Attributes52.from_hash(hash['attributes']) if hash['attributes']
      ...
      relationships = TransactionFileRelationships.from_hash(hash['relationships']) if
        hash['relationships']
      type = hash.key?('type') ? hash['type'] : SKIP
      version = hash.key?('version') ? hash['version'] : SKIP

      # Create object from extracted values.
      NewTransactionFile.new(attributes,
                             id,
                             organisation_id,
                             created_on,
                             modified_on,
