...
module Form3PublicApi
  # SubscriptionDeliveryError Model.
  class SubscriptionDeliveryError < BaseModel
    SKIP = Object.new
    ...
    # TODO: Write general description for this method
    # @return [Relationships25]
    attr_accessor :relationships

    # TODO: Write general description for this method
    # @return [SubscriptionDeliveryErrorTypeEnum]
    attr_accessor :type
    ...
    def self.from_hash(hash)
      ...
      attributes = Attributes69.from_hash(hash['attributes']) if hash['attributes']
      ...
      relationships = Relationships25.from_hash(hash['relationships']) if hash['relationships']
      type = hash.key?('type') ? hash['type'] : SKIP
      version = hash.key?('version') ? hash['version'] : SKIP

      # Create object from extracted values.
      SubscriptionDeliveryError.new(attributes,
                                    created_on,
                                    id,
                                    modified_on,
                                    organisation_id,
