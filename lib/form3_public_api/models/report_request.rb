...
module Form3PublicApi
  ...
  class ReportRequest < BaseModel
    ...
    def self.from_hash(hash)
      ...
      attributes = ReportRequestAttributes.from_hash(hash['attributes']) if hash['attributes']
      ...
      relationships = ReportRequestRelationships.from_hash(hash['relationships']) if
        hash['relationships']
      type = hash.key?('type') ? hash['type'] : SKIP
      version = hash.key?('version') ? hash['version'] : SKIP

      # Create object from extracted values.
      ReportRequest.new(attributes,
                        id,
                        organisation_id,
                        created_on,
                        modified_on,
