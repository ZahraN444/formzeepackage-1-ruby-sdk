...
module Form3PublicApi
  # ReceiversCorrespondentAccountHoldingEntity Model.
  class ReceiversCorrespondentAccountHoldingEntity < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      ReceiversCorrespondentAccountHoldingEntity.new(bank_address,
                                                     bank_id,
                                                     bank_id_code,
                                                     bank_name,
                                                     bank_party_id)
