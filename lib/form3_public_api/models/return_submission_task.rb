...
module Form3PublicApi
  # ReturnSubmissionTask Model.
  class ReturnSubmissionTask < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      relationships = ReturnSubmissionTaskRelationships.from_hash(hash['relationships']) if
        hash['relationships']
      type = hash.key?('type') ? hash['type'] : SKIP
      version = hash.key?('version') ? hash['version'] : SKIP

      # Create object from extracted values.
      ReturnSubmissionTask.new(attributes,
                               created_on,
                               id,
                               modified_on,
                               organisation_id,
