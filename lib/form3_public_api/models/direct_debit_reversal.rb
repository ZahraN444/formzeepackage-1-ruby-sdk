...
module Form3PublicApi
  # DirectDebitReversal Model.
  class DirectDebitReversal < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      attributes = Attributes35.from_hash(hash['attributes']) if hash['attributes']
