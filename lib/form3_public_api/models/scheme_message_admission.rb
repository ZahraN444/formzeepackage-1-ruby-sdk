...
module Form3PublicApi
  # SchemeMessageAdmission Model.
  class SchemeMessageAdmission < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      attributes = SchemeMessageAdmissionAttributes.from_hash(hash['attributes']) if
        hash['attributes']
      relationships = SchemeMessageAdmissionRelationships.from_hash(hash['relationships']) if
        hash['relationships']
      type = hash.key?('type') ? hash['type'] : SKIP
      version = hash.key?('version') ? hash['version'] : SKIP

      # Create object from extracted values.
      SchemeMessageAdmission.new(id,
                                 organisation_id,
                                 attributes,
                                 relationships,
                                 type,
