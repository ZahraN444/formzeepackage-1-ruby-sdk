...
module Form3PublicApi
  ...
  class PaymentSubmission < BaseModel
    ...
    def self.from_hash(hash)
      ...
      attributes = Attributes16.from_hash(hash['attributes']) if hash['attributes']
      ...
      relationships = PaymentSubmissionRelationships.from_hash(hash['relationships']) if
        hash['relationships']
      type = hash.key?('type') ? hash['type'] : SKIP
      version = hash.key?('version') ? hash['version'] : SKIP

      # Create object from extracted values.
      PaymentSubmission.new(id,
                            organisation_id,
                            attributes,
                            created_on,
                            modified_on,
