...
module Form3PublicApi
  # DirectDebitRecallSubmission Model.
  class DirectDebitRecallSubmission < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      attributes = Attributes30.from_hash(hash['attributes']) if hash['attributes']
      ...
      relationships = Relationships8.from_hash(hash['relationships']) if hash['relationships']
      type = hash.key?('type') ? hash['type'] : SKIP
      version = hash.key?('version') ? hash['version'] : SKIP

      # Create object from extracted values.
      DirectDebitRecallSubmission.new(id,
                                      organisation_id,
                                      attributes,
                                      created_on,
                                      modified_on,
