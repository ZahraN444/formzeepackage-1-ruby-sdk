...
module Form3PublicApi
  # ReversalAdmissionTask Model.
  class ReversalAdmissionTask < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      attributes = Attributes15.from_hash(hash['attributes']) if hash['attributes']
      ...
      relationships = ReversalAdmissionTaskRelationships.from_hash(hash['relationships']) if
        hash['relationships']
      type = hash.key?('type') ? hash['type'] : SKIP
      version = hash.key?('version') ? hash['version'] : SKIP

      # Create object from extracted values.
      ReversalAdmissionTask.new(attributes,
                                created_on,
                                id,
                                modified_on,
                                organisation_id,
