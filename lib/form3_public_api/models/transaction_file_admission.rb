...
module Form3PublicApi
  # TransactionFileAdmission Model.
  class TransactionFileAdmission < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      attributes = Attributes43.from_hash(hash['attributes']) if hash['attributes']
      ...
      relationships = TransactionFileAdmissionRelationships.from_hash(hash['relationships']) if
        hash['relationships']
      type = hash.key?('type') ? hash['type'] : SKIP
      version = hash.key?('version') ? hash['version'] : SKIP

      # Create object from extracted values.
      TransactionFileAdmission.new(id,
                                   organisation_id,
                                   attributes,
                                   created_on,
                                   modified_on,
