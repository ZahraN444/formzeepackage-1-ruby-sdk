...
module Form3PublicApi
  ...
  class Claim < BaseModel
    ...
    def self.from_hash(hash)
      ...
      attributes = ClaimAttributes.from_hash(hash['attributes']) if hash['attributes']
      ...
      relationships = ClaimRelationships.from_hash(hash['relationships']) if hash['relationships']
