...
module Form3PublicApi
  # DirectDebitReturnAdmission Model.
  class DirectDebitReturnAdmission < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      attributes = Attributes32.from_hash(hash['attributes']) if hash['attributes']
      ...
      relationships = DirectDebitReturnAdmissionRelationships.from_hash(hash['relationships']) if
        hash['relationships']
      type = hash.key?('type') ? hash['type'] : SKIP
      version = hash.key?('version') ? hash['version'] : SKIP

      # Create object from extracted values.
      DirectDebitReturnAdmission.new(attributes,
                                     id,
                                     organisation_id,
                                     created_on,
                                     modified_on,
