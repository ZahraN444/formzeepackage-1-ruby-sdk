...
module Form3PublicApi
  # MandateAdmission Model.
  class MandateAdmission < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      attributes = Attributes45.from_hash(hash['attributes']) if hash['attributes']
      ...
      relationships = MandateAdmissionRelationships.from_hash(hash['relationships']) if
        hash['relationships']
      type = hash.key?('type') ? hash['type'] : SKIP
      version = hash.key?('version') ? hash['version'] : SKIP

      # Create object from extracted values.
      MandateAdmission.new(attributes,
                           created_on,
                           id,
                           modified_on,
                           organisation_id,
