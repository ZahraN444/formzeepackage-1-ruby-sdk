...
module Form3PublicApi
  # ClaimReversalSubmission Model.
  class ClaimReversalSubmission < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      attributes = Attributes21.from_hash(hash['attributes']) if hash['attributes']
      ...
      relationships = ClaimReversalSubmissionRelationships.from_hash(hash['relationships']) if
        hash['relationships']
      type = hash.key?('type') ? hash['type'] : SKIP
      version = hash.key?('version') ? hash['version'] : SKIP

      # Create object from extracted values.
      ClaimReversalSubmission.new(id,
                                  organisation_id,
                                  attributes,
                                  created_on,
                                  modified_on,
