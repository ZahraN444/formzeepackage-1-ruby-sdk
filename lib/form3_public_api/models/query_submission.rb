...
module Form3PublicApi
  ...
  class QuerySubmission < BaseModel
    ...
    def self.from_hash(hash)
      ...
      attributes = QuerySubmissionAttributes.from_hash(hash['attributes']) if hash['attributes']
      ...
      relationships = QuerySubmissionRelationships.from_hash(hash['relationships']) if
        hash['relationships']

      # Create object from extracted values.
      QuerySubmission.new(attributes,
                          id,
                          organisation_id,
                          version,
                          created_on,
