...
module Form3PublicApi
  # DirectDebitReturnSubmission Model.
  class DirectDebitReturnSubmission < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      attributes = Attributes34.from_hash(hash['attributes']) if hash['attributes']
      ...
      DirectDebitReturnSubmission.new(id,
                                      organisation_id,
                                      attributes,
                                      created_on,
                                      modified_on,
