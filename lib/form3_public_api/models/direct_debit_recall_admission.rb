...
module Form3PublicApi
  # DirectDebitRecallAdmission Model.
  class DirectDebitRecallAdmission < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      attributes = Attributes29.from_hash(hash['attributes']) if hash['attributes']
      ...
      DirectDebitRecallAdmission.new(id,
                                     attributes,
                                     created_on,
                                     modified_on,
                                     organisation_id,
