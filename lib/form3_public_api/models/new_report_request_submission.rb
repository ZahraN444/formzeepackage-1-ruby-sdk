...
module Form3PublicApi
  # NewReportRequestSubmission Model.
  class NewReportRequestSubmission < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      attributes = NewReportRequestSubmissionAttributes.from_hash(hash['attributes']) if
        hash['attributes']
      version = hash.key?('version') ? hash['version'] : SKIP

      # Create object from extracted values.
      NewReportRequestSubmission.new(id,
                                     organisation_id,
                                     attributes,
                                     version)
    end
