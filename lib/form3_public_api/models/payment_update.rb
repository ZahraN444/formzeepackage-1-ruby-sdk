...
module Form3PublicApi
  ...
  class PaymentUpdate < BaseModel
    ...
    def self.from_hash(hash)
      ...
      attributes = PaymentAttributes.from_hash(hash['attributes']) if hash['attributes']
      ...
      relationships = PaymentUpdateRelationships.from_hash(hash['relationships']) if
        hash['relationships']
      type = hash.key?('type') ? hash['type'] : SKIP

      # Create object from extracted values.
      PaymentUpdate.new(attributes,
                        id,
                        organisation_id,
                        version,
                        created_on,
