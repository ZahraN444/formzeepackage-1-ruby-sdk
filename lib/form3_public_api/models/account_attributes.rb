...
module Form3PublicApi
  ...
  class AccountAttributes < BaseModel
    ...
    def self.from_hash(hash)
      ...
      account_classification =
        hash['account_classification'] ||= AccountClassification1Enum::PERSONAL
      account_matching_opt_out = hash['account_matching_opt_out'] ||= false
      account_number =
      ...
      joint_account = hash['joint_account'] ||= false
      name = hash.key?('name') ? hash['name'] : SKIP
      name_matching_status =
        hash['name_matching_status'] ||= NameMatchingStatusEnum::SUPPORTED
