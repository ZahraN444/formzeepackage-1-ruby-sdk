...
module Form3PublicApi
  # DirectDebitDecisionAdmission Model.
  class DirectDebitDecisionAdmission < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      attributes = Attributes26.from_hash(hash['attributes']) if hash['attributes']
      ...
      relationships = DirectDebitDecisionAdmissionRelationships.from_hash(hash['relationships']) if
        hash['relationships']
      type = hash.key?('type') ? hash['type'] : SKIP
      version = hash.key?('version') ? hash['version'] : SKIP

      # Create object from extracted values.
      DirectDebitDecisionAdmission.new(attributes,
                                       id,
                                       organisation_id,
                                       created_on,
                                       modified_on,
