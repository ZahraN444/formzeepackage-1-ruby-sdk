...
module Form3PublicApi
  # ReturnAdmissionFetch Model.
  class ReturnAdmissionFetch < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      relationships = ReturnAdmissionFetchRelationships.from_hash(hash['relationships']) if
        hash['relationships']
      type = hash.key?('type') ? hash['type'] : SKIP
      version = hash.key?('version') ? hash['version'] : SKIP

      # Create object from extracted values.
      ReturnAdmissionFetch.new(id,
                               organisation_id,
                               attributes,
                               created_on,
                               modified_on,
