...
module Form3PublicApi
  ...
  class ReturnPayment < BaseModel
    ...
    def self.from_hash(hash)
      ...
      attributes = ReturnPaymentAttributes.from_hash(hash['attributes']) if hash['attributes']
      ...
      relationships = ReturnPaymentRelationships.from_hash(hash['relationships']) if
        hash['relationships']
      type = hash.key?('type') ? hash['type'] : SKIP
      version = hash.key?('version') ? hash['version'] : SKIP

      # Create object from extracted values.
      ReturnPayment.new(id,
                        organisation_id,
                        attributes,
                        created_on,
                        modified_on,
