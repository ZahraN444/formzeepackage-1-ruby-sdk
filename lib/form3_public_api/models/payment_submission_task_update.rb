...
module Form3PublicApi
  # PaymentSubmissionTaskUpdate Model.
  class PaymentSubmissionTaskUpdate < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      attributes = Attributes54.from_hash(hash['attributes']) if hash['attributes']
      ...
      PaymentSubmissionTaskUpdate.new(attributes,
                                      id,
                                      organisation_id,
                                      type,
                                      version)
