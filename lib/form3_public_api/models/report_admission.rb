...
module Form3PublicApi
  # ReportAdmission Model.
  class ReportAdmission < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      attributes = ReportAdmissionAttributes.from_hash(hash['attributes']) if hash['attributes']
      ...
      relationships = ReportAdmissionRelationships.from_hash(hash['relationships']) if
        hash['relationships']
      type = hash.key?('type') ? hash['type'] : SKIP
      version = hash.key?('version') ? hash['version'] : SKIP

      # Create object from extracted values.
      ReportAdmission.new(id,
                          organisation_id,
                          attributes,
                          created_on,
                          modified_on,
