...
module Form3PublicApi
  ...
  class SchemeFile < BaseModel
    ...
    def self.from_hash(hash)
      ...
      attributes = Attributes39.from_hash(hash['attributes']) if hash['attributes']
      ...
      relationships = SchemeFileRelationships.from_hash(hash['relationships']) if
        hash['relationships']
      type = hash.key?('type') ? hash['type'] : SKIP
      version = hash.key?('version') ? hash['version'] : SKIP

      # Create object from extracted values.
      SchemeFile.new(attributes,
                     id,
                     organisation_id,
                     created_on,
                     modified_on,
