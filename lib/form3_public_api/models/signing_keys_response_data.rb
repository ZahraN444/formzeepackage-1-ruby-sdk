...
module Form3PublicApi
  # SigningKeysResponseData Model.
  class SigningKeysResponseData < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      attributes = SigningKeysAttributes.from_hash(hash['attributes']) if hash['attributes']
      ...
      SigningKeysResponseData.new(attributes,
                                  id,
                                  organisation_id,
                                  version,
                                  created_on,
