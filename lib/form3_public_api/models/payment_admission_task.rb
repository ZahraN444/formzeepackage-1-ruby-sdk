...
module Form3PublicApi
  # PaymentAdmissionTask Model.
  class PaymentAdmissionTask < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      attributes = Attributes7.from_hash(hash['attributes']) if hash['attributes']
      ...
      relationships = PaymentAdmissionTaskRelationships.from_hash(hash['relationships']) if
        hash['relationships']
      type = hash.key?('type') ? hash['type'] : SKIP
      version = hash.key?('version') ? hash['version'] : SKIP

      # Create object from extracted values.
      PaymentAdmissionTask.new(attributes,
                               created_on,
                               id,
                               modified_on,
                               organisation_id,
