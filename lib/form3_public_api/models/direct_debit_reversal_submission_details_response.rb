...
module Form3PublicApi
  # DirectDebitReversalSubmissionDetailsResponse Model.
  class DirectDebitReversalSubmissionDetailsResponse < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      DirectDebitReversalSubmissionDetailsResponse.new(data,
                                                       links)
    end
  end
end
