...
module Form3PublicApi
  # DirectDebitDecisionSubmission Model.
  class DirectDebitDecisionSubmission < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      attributes = Attributes27.from_hash(hash['attributes']) if hash['attributes']
      ...
      DirectDebitDecisionSubmission.new(id,
                                        organisation_id,
                                        attributes,
                                        created_on,
                                        modified_on,
