...
module Form3PublicApi
  ...
  class NameVerification < BaseModel
    ...
    def self.from_hash(hash)
      ...
      attributes = NameVerificationAttributes.from_hash(hash['attributes']) if hash['attributes']
      ...
      relationships = NameVerificationRelationships.from_hash(hash['relationships']) if
        hash['relationships']
      type = hash.key?('type') ? hash['type'] : SKIP
      version = hash.key?('version') ? hash['version'] : SKIP

      # Create object from extracted values.
      NameVerification.new(attributes,
                           id,
                           organisation_id,
                           created_on,
                           modified_on,
