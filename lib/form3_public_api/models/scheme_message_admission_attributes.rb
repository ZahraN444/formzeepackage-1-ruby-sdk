...
module Form3PublicApi
  # SchemeMessageAdmissionAttributes Model.
  class SchemeMessageAdmissionAttributes < BaseModel
    SKIP = Object.new
    ...
    # TODO: Write general description for this method
    # @return [SchemeMessageAdmissionStatusEnum]
    ...
    def self.from_hash(hash)
      ...
      SchemeMessageAdmissionAttributes.new(admission_datetime,
                                           scheme_status_code,
                                           scheme_status_code_description,
                                           status)
    end
