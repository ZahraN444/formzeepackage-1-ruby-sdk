...
module Form3PublicApi
  # QueryResponseSubmission Model.
  class QueryResponseSubmission < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      attributes = QueryResponseSubmissionAttributes.from_hash(hash['attributes']) if
        hash['attributes']
      ...
      relationships = QueryResponseSubmissionRelationships.from_hash(hash['relationships']) if
        hash['relationships']

      # Create object from extracted values.
      QueryResponseSubmission.new(attributes,
                                  id,
                                  organisation_id,
                                  version,
                                  created_on,
