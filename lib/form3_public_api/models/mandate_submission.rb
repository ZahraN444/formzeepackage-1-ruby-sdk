...
module Form3PublicApi
  ...
  class MandateSubmission < BaseModel
    ...
    def self.from_hash(hash)
      ...
      attributes = Attributes48.from_hash(hash['attributes']) if hash['attributes']
      ...
      relationships = MandateSubmissionRelationships.from_hash(hash['relationships']) if
        hash['relationships']
      type = hash.key?('type') ? hash['type'] : SKIP
      version = hash.key?('version') ? hash['version'] : SKIP

      # Create object from extracted values.
      MandateSubmission.new(attributes,
                            created_on,
                            id,
                            modified_on,
                            organisation_id,
