...
module Form3PublicApi
  # MandateReturnSubmission Model.
  class MandateReturnSubmission < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      attributes = Attributes47.from_hash(hash['attributes']) if hash['attributes']
      ...
      relationships = Relationships18.from_hash(hash['relationships']) if hash['relationships']
      type = hash.key?('type') ? hash['type'] : SKIP
      version = hash.key?('version') ? hash['version'] : SKIP

      # Create object from extracted values.
      MandateReturnSubmission.new(attributes,
                                  created_on,
                                  id,
                                  modified_on,
                                  organisation_id,
