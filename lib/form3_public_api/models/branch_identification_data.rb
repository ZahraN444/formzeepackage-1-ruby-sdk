...
module Form3PublicApi
  # BranchIdentificationData Model.
  class BranchIdentificationData < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      relationships = BranchIdentificationRelationships.from_hash(hash['relationships']) if
        hash['relationships']

      # Create object from extracted values.
      BranchIdentificationData.new(attributes,
                                   id,
                                   organisation_id,
                                   created_on,
                                   modified_on,
