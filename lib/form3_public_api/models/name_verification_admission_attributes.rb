...
module Form3PublicApi
  # NameVerificationAdmissionAttributes Model.
  class NameVerificationAdmissionAttributes < BaseModel
    SKIP = Object.new
    ...
    # TODO: Write general description for this method
    # @return [NameVerificationAdmissionAnswerEnum]
    ...
    # TODO: Write general description for this method
    # @return [NameVerificationAdmissionReasonCodeEnum]
    attr_accessor :reason_code

    # TODO: Write general description for this method
    # @return [NameVerificationAdmissionStatusEnum]
    ...
    def self.from_hash(hash)
      ...
      NameVerificationAdmissionAttributes.new(status,
                                              actual_name,
                                              answer,
                                              reason,
                                              reason_code,
