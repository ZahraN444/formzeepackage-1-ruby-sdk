...
module Form3PublicApi
  # PaymentAdmissionTaskUpdate Model.
  class PaymentAdmissionTaskUpdate < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      attributes = Attributes53.from_hash(hash['attributes']) if hash['attributes']
      ...
      PaymentAdmissionTaskUpdate.new(attributes,
                                     id,
                                     organisation_id,
                                     type,
                                     version)
