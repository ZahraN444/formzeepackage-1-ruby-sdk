...
module Form3PublicApi
  # AccountIdentificationEventData Model.
  class AccountIdentificationEventData < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      relationships = AccountIdentificationEventRelationships.from_hash(hash['relationships']) if
        hash['relationships']

      # Create object from extracted values.
      AccountIdentificationEventData.new(attributes,
                                         id,
                                         organisation_id,
                                         created_on,
                                         modified_on,
