...
module Form3PublicApi
  # UltimateEntity Model.
  class UltimateEntity < BaseModel
    SKIP = Object.new
    ...
    # Country of residence of the ultimate beneficiary, ISO 3166 format country
    # code
    # @return [String]
    ...
    def self.from_hash(hash)
      ...
      UltimateEntity.new(additional_address_line,
                         address,
                         birth_city,
                         birth_country,
                         birth_date,
