...
module Form3PublicApi
  # DirectDebitDecision Model.
  class DirectDebitDecision < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      attributes = Attributes25.from_hash(hash['attributes']) if hash['attributes']
      ...
      DirectDebitDecision.new(attributes,
                              id,
                              organisation_id,
                              created_on,
                              modified_on,
