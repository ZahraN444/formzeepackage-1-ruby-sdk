...
module Form3PublicApi
  ...
  class MandateReturn < BaseModel
    ...
    def self.from_hash(hash)
      ...
      attributes = Attributes46.from_hash(hash['attributes']) if hash['attributes']
      ...
      relationships = Relationships17.from_hash(hash['relationships']) if hash['relationships']
      type = hash.key?('type') ? hash['type'] : SKIP
      version = hash.key?('version') ? hash['version'] : SKIP

      # Create object from extracted values.
      MandateReturn.new(attributes,
                        created_on,
                        id,
                        modified_on,
                        organisation_id,
