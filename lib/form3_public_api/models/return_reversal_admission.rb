...
module Form3PublicApi
  # ReturnReversalAdmission Model.
  class ReturnReversalAdmission < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      attributes = Attributes63.from_hash(hash['attributes']) if hash['attributes']
      ...
      relationships = ReturnReversalAdmissionRelationships.from_hash(hash['relationships']) if
        hash['relationships']
      type = hash.key?('type') ? hash['type'] : SKIP
      version = hash.key?('version') ? hash['version'] : SKIP

      # Create object from extracted values.
      ReturnReversalAdmission.new(id,
                                  organisation_id,
                                  attributes,
                                  created_on,
                                  modified_on,
