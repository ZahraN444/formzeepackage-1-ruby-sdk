...
module Form3PublicApi
  # SchemeFileAdmission Model.
  class SchemeFileAdmission < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      attributes = Attributes40.from_hash(hash['attributes']) if hash['attributes']
      ...
      relationships = SchemeFileAdmissionRelationships.from_hash(hash['relationships']) if
        hash['relationships']
      type = hash.key?('type') ? hash['type'] : SKIP
      version = hash.key?('version') ? hash['version'] : SKIP

      # Create object from extracted values.
      SchemeFileAdmission.new(id,
                              organisation_id,
                              attributes,
                              created_on,
                              modified_on,
