...
module Form3PublicApi
  # RecallReversalAdmission Model.
  class RecallReversalAdmission < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      attributes = RecallReversalAdmissionAttributes.from_hash(hash['attributes']) if
        hash['attributes']
      ...
      relationships = Relationships22.from_hash(hash['relationships']) if hash['relationships']
      type = hash.key?('type') ? hash['type'] : SKIP
      version = hash.key?('version') ? hash['version'] : SKIP

      # Create object from extracted values.
      RecallReversalAdmission.new(id,
                                  organisation_id,
                                  attributes,
                                  created_on,
                                  modified_on,
