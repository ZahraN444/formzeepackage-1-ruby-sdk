...
module Form3PublicApi
  # DirectDebitReversalSubmissionCreationResponse Model.
  class DirectDebitReversalSubmissionCreationResponse < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      DirectDebitReversalSubmissionCreationResponse.new(data,
                                                        links)
    end
  end
end
