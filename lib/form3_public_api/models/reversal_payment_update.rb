...
module Form3PublicApi
  # ReversalPaymentUpdate Model.
  class ReversalPaymentUpdate < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      attributes = Attributes13.from_hash(hash['attributes']) if hash['attributes']
