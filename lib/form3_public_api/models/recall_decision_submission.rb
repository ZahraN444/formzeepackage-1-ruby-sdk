...
module Form3PublicApi
  # RecallDecisionSubmission Model.
  class RecallDecisionSubmission < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      attributes = RecallDecisionSubmissionAttributes.from_hash(hash['attributes']) if
        hash['attributes']
      ...
      relationships = RecallDecisionSubmissionRelationships.from_hash(hash['relationships']) if
        hash['relationships']
      type = hash.key?('type') ? hash['type'] : SKIP
      version = hash.key?('version') ? hash['version'] : SKIP

      # Create object from extracted values.
      RecallDecisionSubmission.new(id,
                                   organisation_id,
                                   attributes,
                                   created_on,
                                   modified_on,
