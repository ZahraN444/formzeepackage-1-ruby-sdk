...
module Form3PublicApi
  # ReversalSubmission Model.
  class ReversalSubmission < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      attributes = Attributes68.from_hash(hash['attributes']) if hash['attributes']
      ...
      relationships = ReversalSubmissionRelationships.from_hash(hash['relationships']) if
        hash['relationships']
      type = hash.key?('type') ? hash['type'] : SKIP
      version = hash.key?('version') ? hash['version'] : SKIP

      # Create object from extracted values.
      ReversalSubmission.new(id,
                             organisation_id,
                             attributes,
                             created_on,
                             modified_on,
