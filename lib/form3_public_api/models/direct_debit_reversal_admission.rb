...
module Form3PublicApi
  # DirectDebitReversalAdmission Model.
  class DirectDebitReversalAdmission < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      attributes = Attributes36.from_hash(hash['attributes']) if hash['attributes']
      ...
      relationships = Relationships15.from_hash(hash['relationships']) if hash['relationships']
      type = hash.key?('type') ? hash['type'] : SKIP
      version = hash.key?('version') ? hash['version'] : SKIP

      # Create object from extracted values.
      DirectDebitReversalAdmission.new(attributes,
                                       id,
                                       organisation_id,
                                       created_on,
                                       modified_on,
