...
module Form3PublicApi
  # TransactionFileSubmission Model.
  class TransactionFileSubmission < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      attributes = Attributes44.from_hash(hash['attributes']) if hash['attributes']
      ...
      relationships = TransactionFileSubmissionRelationships.from_hash(hash['relationships']) if
        hash['relationships']
      type = hash.key?('type') ? hash['type'] : SKIP
      version = hash.key?('version') ? hash['version'] : SKIP

      # Create object from extracted values.
      TransactionFileSubmission.new(id,
                                    organisation_id,
                                    attributes,
                                    created_on,
                                    modified_on,
