...
module Form3PublicApi
  # DirectDebitAdmission Model.
  class DirectDebitAdmission < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      attributes = Attributes24.from_hash(hash['attributes']) if hash['attributes']
      ...
      relationships = DirectDebitAdmissionRelationships.from_hash(hash['relationships']) if
        hash['relationships']
      type = hash.key?('type') ? hash['type'] : SKIP
      version = hash.key?('version') ? hash['version'] : SKIP

      # Create object from extracted values.
      DirectDebitAdmission.new(attributes,
                               id,
                               organisation_id,
                               created_on,
                               modified_on,
