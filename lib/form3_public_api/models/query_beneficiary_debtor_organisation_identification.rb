...
module Form3PublicApi
  # QueryBeneficiaryDebtorOrganisationIdentification Model.
  class QueryBeneficiaryDebtorOrganisationIdentification < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      QueryBeneficiaryDebtorOrganisationIdentification.new(identification,
                                                           identification_code,
                                                           identification_issuer,
                                                           identification_scheme)
    end
