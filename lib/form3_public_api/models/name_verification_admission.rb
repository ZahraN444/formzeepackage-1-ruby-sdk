...
module Form3PublicApi
  # NameVerificationAdmission Model.
  class NameVerificationAdmission < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      attributes = NameVerificationAdmissionAttributes.from_hash(hash['attributes']) if
        hash['attributes']
      ...
      relationships = NameVerificationAdmissionRelationships.from_hash(hash['relationships']) if
        hash['relationships']
      type = hash.key?('type') ? hash['type'] : SKIP
      version = hash.key?('version') ? hash['version'] : SKIP

      # Create object from extracted values.
      NameVerificationAdmission.new(attributes,
                                    id,
                                    organisation_id,
                                    created_on,
                                    modified_on,
