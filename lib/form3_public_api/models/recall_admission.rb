...
module Form3PublicApi
  # RecallAdmission Model.
  class RecallAdmission < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      attributes = Attributes56.from_hash(hash['attributes']) if hash['attributes']
      ...
      relationships = RecallAdmissionRelationships.from_hash(hash['relationships']) if
        hash['relationships']
      type = hash.key?('type') ? hash['type'] : SKIP
      version = hash.key?('version') ? hash['version'] : SKIP

      # Create object from extracted values.
      RecallAdmission.new(id,
                          organisation_id,
                          attributes,
                          created_on,
                          modified_on,
