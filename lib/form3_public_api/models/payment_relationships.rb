...
module Form3PublicApi
  ...
  class PaymentRelationships < BaseModel
    ...
    def self.from_hash(hash)
      ...
      forwarding_payment = ForwardingPayment.from_hash(hash['forwarding_payment']) if
      ...
      PaymentRelationships.new(beneficiary,
                               beneficiary_account,
                               debtor,
                               debtor_account,
                               forwarded_payment,
