...
module Form3PublicApi
  # NameVerificationSubmission Model.
  class NameVerificationSubmission < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      attributes = NameVerificationSubmissionAttributes.from_hash(hash['attributes']) if
        hash['attributes']
      ...
      relationships = NameVerificationSubmissionRelationships.from_hash(hash['relationships']) if
        hash['relationships']
      type = hash.key?('type') ? hash['type'] : SKIP
      version = hash.key?('version') ? hash['version'] : SKIP

      # Create object from extracted values.
      NameVerificationSubmission.new(id,
                                     organisation_id,
                                     attributes,
                                     created_on,
                                     modified_on,
