...
module Form3PublicApi
  # DirectDebitReturn Model.
  class DirectDebitReturn < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      attributes = Attributes31.from_hash(hash['attributes']) if hash['attributes']
      ...
      DirectDebitReturn.new(attributes,
                            id,
                            organisation_id,
                            created_on,
                            modified_on,
