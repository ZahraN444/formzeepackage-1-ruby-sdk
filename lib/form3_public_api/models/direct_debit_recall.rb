...
module Form3PublicApi
  # DirectDebitRecall Model.
  class DirectDebitRecall < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      attributes = Attributes8.from_hash(hash['attributes']) if hash['attributes']
      ...
      relationships = Relationships7.from_hash(hash['relationships']) if hash['relationships']
      type = hash.key?('type') ? hash['type'] : SKIP
      version = hash.key?('version') ? hash['version'] : SKIP

      # Create object from extracted values.
      DirectDebitRecall.new(id,
                            attributes,
                            created_on,
                            modified_on,
                            organisation_id,
