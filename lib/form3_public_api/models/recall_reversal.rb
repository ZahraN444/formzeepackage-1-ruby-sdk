...
module Form3PublicApi
  # RecallReversal Model.
  class RecallReversal < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      relationships = Relationships21.from_hash(hash['relationships']) if hash['relationships']
      type = hash.key?('type') ? hash['type'] : SKIP
      version = hash.key?('version') ? hash['version'] : SKIP

      # Create object from extracted values.
      RecallReversal.new(id,
                         organisation_id,
                         attributes,
                         created_on,
                         modified_on,
