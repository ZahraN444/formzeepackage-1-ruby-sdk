...
module Form3PublicApi
  # DirectDebitReversalSubmission Model.
  class DirectDebitReversalSubmission < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      attributes = Attributes37.from_hash(hash['attributes']) if hash['attributes']
      ...
      DirectDebitReversalSubmission.new(id,
                                        organisation_id,
                                        attributes,
                                        created_on,
                                        modified_on,
