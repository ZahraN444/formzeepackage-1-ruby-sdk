...
module Form3PublicApi
  # SchemeFileSubmission Model.
  class SchemeFileSubmission < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      attributes = Attributes41.from_hash(hash['attributes']) if hash['attributes']
      ...
      relationships = SchemeFileSubmissionRelationships.from_hash(hash['relationships']) if
        hash['relationships']
      type = hash.key?('type') ? hash['type'] : SKIP
      version = hash.key?('version') ? hash['version'] : SKIP

      # Create object from extracted values.
      SchemeFileSubmission.new(id,
                               organisation_id,
                               attributes,
                               created_on,
                               modified_on,
