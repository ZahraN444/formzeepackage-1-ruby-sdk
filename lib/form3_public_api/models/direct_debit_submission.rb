...
module Form3PublicApi
  ...
  class DirectDebitSubmission < BaseModel
    ...
    def self.from_hash(hash)
      ...
      attributes = Attributes38.from_hash(hash['attributes']) if hash['attributes']
      ...
      relationships = DirectDebitSubmissionRelationships.from_hash(hash['relationships']) if
        hash['relationships']
      type = hash.key?('type') ? hash['type'] : SKIP
      version = hash.key?('version') ? hash['version'] : SKIP

      # Create object from extracted values.
      DirectDebitSubmission.new(id,
                                organisation_id,
                                attributes,
                                created_on,
                                modified_on,
